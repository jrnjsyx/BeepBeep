...
Java_com_example_jrnjsyx_beepbeep_utils_JniUtils_sayHello(JNIEnv *env, jclass jobj) {
...
Java_com_example_jrnjsyx_beepbeep_utils_JniUtils_fft(JNIEnv *env, jclass jobj,
...
JNIEXPORT jfloatArray JNICALL
Java_com_example_jrnjsyx_beepbeep_utils_JniUtils_xcorr(JNIEnv *env, jclass jobj,jfloatArray data1,jfloatArray data2){
