...
import physical.SignalGenerator;
...
public class Decoder implements FlagVar {
    ...
    public void setProcessBufferSize(int processBufferSize){
        ...
        bufferedSamples = new short[processBufferSize+LPreamble];
    ...
    public short[] bufferedSamples = new short[processBufferSize+LPreamble];
